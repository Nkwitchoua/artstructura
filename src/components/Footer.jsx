  ...
  return (
    <Row className='w-100 bg-dark text-light py-3 py-sm-5 px-3 px-sm-4 align-items-center m-0'>
        ...
        <Col className='d-flex row gap-3 gap-md-5'>
            <a style={{cursor: "pointer", textDecoration: "none", color: "white"}} className="fs-regular" href="/about-us">О нас</a>
            <a style={{cursor: "pointer", textDecoration: "none", color: "red"}} className="fs-regular" href="#">Одежда (в разработке)</a>
